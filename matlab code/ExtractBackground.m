...
bk_downsample = 300; %The downsample factor for frame averaging
disp('Opening video...')
vob = VideoReader('5.mp4'); %A warning about being unable to read the number of frames is due to variable frame rate (normal)
